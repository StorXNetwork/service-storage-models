...
ContactSchema.methods.updateContactErrorCount = function () {
  let currentErrorCount = this.errorCount || 0;
  let newPoints = currentErrorCount + 1;
  this.errorCount = newPoints;
  return this;
};

ContactSchema.methods.resetContactErrorCount = function () {
  this.errorCount = 0;
  return this;
};
...
ContactSchema.statics.updateLastContractSent = function (id, callback) {
  this.updateOne({ _id: id },
    { $set: { lastContractSent: Date.now() } }, callback);
};
